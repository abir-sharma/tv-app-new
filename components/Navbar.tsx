    ...
    <View className=" flex-row justify-between items-center p-4">
        ...
        <View className=' -ml-20 rounded-xl flex-row bg-[#0d0d0d] border-[1px] border-white/5'>
            ...
            android_ripple={{
                ...
                radius: 1000,
                foreground: true
            }} onPress={()=>{setIsOnline(true)}} className={`w-52 h-10 overflow-hidden rounded-xl items-center justify-center ${isOnline?  " bg-white/10 border-[1px] border-white/20 ": ''}`}>
            ...
            <Pressable android_ripple={{
                ...
                radius: 1000,
                foreground: true
            }} onPress={()=>{setIsOnline(false)}} className={`w-52 h-10 overflow-hidden rounded-xl items-center justify-center ${!isOnline?  " bg-white/10 border-[1px] border-white/20 ": ''}`}>
