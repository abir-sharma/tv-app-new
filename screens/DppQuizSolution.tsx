            ...
            {questionType === 'Numeric' && <View className='gap-y-2 mt-5 w-[100%]'>
              {
                ...
                <View className={`bg-white/5 px-5 py-3 rounded-lg flex flex-row justify-between ${currentQuestion?.question?.solutionText === currentQuestion?.yourResult?.markedSolutionText ? 'bg-green-400' : 'bg-red-400'}`}>
              ...
              }
              {
                ...
                <View className={`bg-white/5 px-5 py-3 rounded-lg flex flex-row justify-between bg-green-400`}>
            ...
            {questionType !== 'Numeric' && <View className='gap-y-2 mt-5 w-[100%]'>
              {
                ...
                <View className={`bg-white/5 px-5 py-3 rounded-lg flex flex-row justify-between ${markedOptions?.includes(currentQuestion?.question?.options[0]?._id) ? correctOptions?.includes(currentQuestion?.question?.options[0]?._id) ? 'bg-green-400' : 'bg-red-400' : correctOptions?.includes(currentQuestion?.question?.options[0]?._id) ? 'bg-green-400' : ''}`}>
              ...
              {
                currentQuestion?.question?.options &&
                <View className={`bg-white/5 px-5 py-3 rounded-lg flex flex-row justify-between ${markedOptions?.includes(currentQuestion?.question?.options[1]?._id) ? correctOptions?.includes(currentQuestion?.question?.options[1]?._id) ? 'bg-green-400' : 'bg-red-400' : correctOptions?.includes(currentQuestion?.question?.options[1]?._id) ? 'bg-green-400' : ''}`}>
              ...
              {
                currentQuestion?.question?.options &&
                <View className={`bg-white/5 px-5 py-3 rounded-lg flex flex-row justify-between ${markedOptions?.includes(currentQuestion?.question?.options[2]?._id) ? correctOptions?.includes(currentQuestion?.question?.options[2]?._id) ? 'bg-green-400' : 'bg-red-400' : correctOptions?.includes(currentQuestion?.question?.options[2]?._id) ? 'bg-green-400' : ''}`}>
              ...
              {
                currentQuestion?.question?.options &&
                <View className={`bg-white/5 px-5 py-3 rounded-lg flex flex-row justify-between ${markedOptions?.includes(currentQuestion?.question?.options[3]?._id) ? correctOptions?.includes(currentQuestion?.question?.options[3]?._id) ? 'bg-green-400' : 'bg-red-400' : correctOptions?.includes(currentQuestion?.question?.options[3]?._id) ? 'bg-green-400' : ''}`}>
