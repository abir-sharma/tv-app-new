...
import { ActivityIndicator, Alert, BackHandler, Image, ImageBackground, Pressable, Text, TextInput, ToastAndroid, View } from 'react-native';
...
export default function Login({ navigation }: any) {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      // console.log("resauth.data",res.data)
