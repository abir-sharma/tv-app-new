...
const RecentVideos = ({ route }: any) => {
  ...
  return (
    <View>
      {playingVideo && <VideoPlayer currentIndex={currentIndex} currentVideos={currentVideos} handlePrevious={handlePrevious} handleNext={handleNext} lectureDetails={playingVideo?.videoDetails} isLive={false} />}
    </View>
  );
};
